...
Cov-2 Condition, or COV2CON for short, is a legacy an instrument for exploring daily and historical values of select COVID-19 epidemiological indicators to help compare the severity of the pandemic across multiple countries.
...
Note: As of January 2026, the servers that provided data updates are no longer be accessible to the application. Consequently, th app uses the default, embedded datasets (dating from around 2020), which are no longer valid.
